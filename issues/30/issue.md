...
updated_at: '2025-10-26T17:08:28Z'
...
(2025/09/04追記)
「ロボットを極める」について何か具体的な目標がある訳ではなく、ただ一つのロボットを改造・改修し続けるイメージ。
何を目指して、どういう方向性で改造するかは悩ましいところ。
競技ロボットの場合、制約が厳しくて自由に改造できない。